...
namespace MicroUpsert
{
    internal class VerificationBuilderImpl : IVerificationBuilder
    {
        ...
        public VerificationBuilderImpl(List<Tuple<KeyIdentity, UpsertCommand>> upsertVectors, List<CallProcedure> procedures)
        {
        ...
        private static Dictionary<KeyIdentity, UpsertCommand> ListOfUpsertsToDictionary(List<Tuple<KeyIdentity, UpsertCommand>> upsertVectors)
        {
        ...
        private void VerifyExpectations(Dictionary<KeyIdentity, UpsertCommand> expectedUpserts, Dictionary<string, CallProcedure> expectedProcedures)
        {
